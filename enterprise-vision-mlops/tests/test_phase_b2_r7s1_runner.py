...
def _canonical_git_attributes_bytes() -> bytes:
    patterns = (
        ...
        "configs/s2_*.toml",
        "configs/s3_*.toml",
        "configs/s4_gpu_batching_runtime.toml",
        "configs/s5_*.toml",
        "configs/s6_*.toml",
        "configs/s7_family_admission.toml",
        "configs/s8_v4_*.toml",
        "configs/scenarios/dolly-instruction-tuning.json",
        "configs/scenarios/manufacturing-visual-inspection.json",
        "configs/scenarios/scienceqa-vlm-evaluation.json",
