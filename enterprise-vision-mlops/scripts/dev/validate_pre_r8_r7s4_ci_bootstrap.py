...
ATTRIBUTES_RULES = (
    ...
    "/enterprise-vision-mlops/ci/pre-r8-r7s5-test-lanes.json text eol=lf",
    "/enterprise-vision-mlops/scripts/dev/invoke_pre_r8_r7s7_review.ps1 text eol=lf",
    "/enterprise-vision-mlops/scripts/dev/invoke_pre_r8_r7s7_windows_qualification.ps1 text eol=lf",
    "/enterprise-vision-mlops/scripts/dev/pre_r8_r7s7_windows_fixture.py text eol=lf",
    "/enterprise-vision-mlops/scripts/dev/prepare_pre_r8_r7s7_windows_qualification.py text eol=lf",
    "/enterprise-vision-mlops/scripts/dev/publish_pre_r8_r7s5_review.py text eol=lf",
    "/enterprise-vision-mlops/scripts/dev/qualify_pre_r8_r7s7_windows.py text eol=lf",
    "/enterprise-vision-mlops/scripts/dev/run_pre_r8_r7s5_validation.py text eol=lf",
    "/enterprise-vision-mlops/scripts/dev/validate_pre_r8_r7s4_ci_bootstrap.py text eol=lf",
    "/enterprise-vision-mlops/scripts/dev/validate_pre_r8_r7s5_ci.py text eol=lf",
    "/enterprise-vision-mlops/src/evm/scale_validation/phase_b2_r7s5_ci.py text eol=lf",
    "/enterprise-vision-mlops/src/evm/scale_validation/phase_b2_r7s4_authority.py text eol=lf",
    "/enterprise-vision-mlops/src/evm/scale_validation/phase_b2_r7s7_admission.py text eol=lf",
    "/enterprise-vision-mlops/src/evm/scale_validation/phase_b2_r7s7_qualification_work_order.py text eol=lf",
    "/enterprise-vision-mlops/tests/test_phase_b2_r7s4_authority.py text eol=lf",
    "/enterprise-vision-mlops/tests/test_phase_b2_r7s5_ci.py text eol=lf",
    "/enterprise-vision-mlops/tests/test_phase_b2_r7s7_admission.py text eol=lf",
    "/enterprise-vision-mlops/tests/test_phase_b2_r7s7_qualification_work_order.py text eol=lf",
    "/enterprise-vision-mlops/tests/test_prepare_pre_r8_r7s7_windows_qualification.py text eol=lf",
    "/enterprise-vision-mlops/tests/test_pre_r8_r7s4_ci_bootstrap.py text eol=lf",
    "/enterprise-vision-mlops/tests/test_publish_pre_r8_r7s5_review.py text eol=lf",
    "/enterprise-vision-mlops/tests/test_qualify_pre_r8_r7s7_windows.py text eol=lf",
    "/enterprise-vision-mlops/tests/test_run_pre_r8_r7s5_validation.py text eol=lf",
)
