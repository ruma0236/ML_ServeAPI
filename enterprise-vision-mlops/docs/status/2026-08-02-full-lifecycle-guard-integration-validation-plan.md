...
| 7 | `EVM-283` | `SCRUM-191` | single-scenario integrated evidence closure | In Progress / blocked: A-D and current runtime PASS; E remains controlled replay without fresh L2/L4/L6 LifecycleRun reachability | `EVM-282` |
