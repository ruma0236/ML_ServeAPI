...
| Stage | Evidence |
|---|---|
| training | `artifacts/reports/training.md`, MLflow run id `09e571333c244cc39d0cdd72ce25a3f1` |
| model registry | `artifacts/reports/model_registry.md`, registry version `5` |
...
MLflow params verified on run `09e571333c244cc39d0cdd72ce25a3f1`:
...
- Final implementation commit verified in trace metadata: `39a4c937`.
