...
- Generated: `2026-08-14T21:10:02Z`
...
- Existing API and serving request boundaries: `apps/api/main.py`, `apps/api/efficientnet_serving.py`
...
- Existing pipeline and tracking clients: `src/evm/core/pipeline.py`, `src/evm/core/http.py`, `src/evm/core/mlflow_client.py`, `orchestration/airflow/dags/enterprise_vision_mlops_daily.py`
- Existing local runtime and monitoring stack: `docker-compose.yml`, `monitoring/prometheus/prometheus.yml`
...
- Existing local telemetry runtime: `docker-compose.yml`, `monitoring/opentelemetry/collector.yaml`, `monitoring/prometheus/prometheus.yml`, `scripts/dev/start_lifecycle_worker.ps1`
...
- `2026-08-14T21:10:02Z` `implementation` / `implementing`: The public in-place delta contract and OTLP Collector integration are being added; no control run or runtime acceptance is claimed.
