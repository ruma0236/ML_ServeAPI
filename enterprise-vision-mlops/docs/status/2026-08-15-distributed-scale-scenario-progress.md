...
- Generated: `2026-08-24T08:45:26Z`
...
- Next action: Run a zero-credit worker-loss v6 preflight, then restart all 21 fault repetitions; start the 30-minute x3 soak only after the fault gate passes.
