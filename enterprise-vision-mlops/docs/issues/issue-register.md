...
| `EVM-270` | Scenario E data and artifact integrity gate | In Progress | Sprint 178 | E0 fixes the Ed25519 local trust root, byte-versus-semantic identity tuple, stable blocker precedence, exact legacy exception boundary, non-disruptive fixture matrix, zero-intent admission fence and measurable acceptance. Implementation and proof remain open. |
