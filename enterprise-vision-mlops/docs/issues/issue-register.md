...
| `S7` | `EVM-297` | Image/VLM/LLM Auxiliary Admission | Implementing | Post-W8 | existing image and generative serving paths now enforce a versioned family-cost admission checkpoint; external sequential CUDA profiles and AC evidence remain pending |
