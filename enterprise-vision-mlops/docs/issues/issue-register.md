...
|---|---|---|---|---|
| `EVM-EPIC-26` | S8-V4 Triton And Heterogeneous-model Operational Validation | Contract Frozen / Jira `SCRUM-209` In Progress | V3 S0-S8 verified | E0 and S6B-M Strict V4 are verified. Canonical X1 is next and remains planned/not run; Integrated V4 remains planned/not run. |
