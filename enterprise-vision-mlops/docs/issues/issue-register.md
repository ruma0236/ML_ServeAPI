...
| `EVM-301` | X1 Heterogeneous-model Concurrency | Contract Frozen / Non-Credit / Jira `SCRUM-212` In Progress | EVM-300 verified | The failed suite `x1-canonical-20260829t195712z-1722de47` remains immutable zero-credit. Remediation `6ae18921...b754b` loads Torch before PyArrow and passed clean-process, focused 20, and combined 75 gates without threshold or matrix changes. Fresh artifact/Q0/calibration is required; the 78-run matrix remains not started. |
