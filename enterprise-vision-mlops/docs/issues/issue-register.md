...
| `EVM-282` | Scenario A post-promotion GPU serving recovery | In Progress / implementation PASS / live proof pending | Post-Sprint 178 | Jira `SCRUM-190`, entry comment `10555`; exact M0/M1 package and Deployment resourceVersion binding, single-use apply/rollback approvals, M1 pointer CAS, committed-M1 UID recovery and separate M0 rollback runner implemented. M1 package re-hash and 497/497 tests pass; no live mutation or acceptance claim yet. |
