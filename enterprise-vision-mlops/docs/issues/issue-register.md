...
| `EVM-301` | X1 Heterogeneous-model Concurrency | Contract Frozen / Non-Credit / Jira `SCRUM-212` In Progress | EVM-300 verified | Four pre-Q0 suites remain immutable zero-credit. Revision `914c9ad...8a6462` restores exact WSL GPU mounts, partial-rollout cleanup ownership, and two-phase file-SD drain; focused 60 and combined X1/S4/ledger 109 passed without threshold or matrix changes. A wholly fresh artifact/Q0/calibration suite is required; 78-run credit remains not started. |
