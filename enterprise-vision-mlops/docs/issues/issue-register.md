...
| `EVM-300` | S6B-M Triton Model Blue/Green | Running / Jira `SCRUM-211` In Progress | EVM-299 verified | Remediation `6c0ab2d16b80845c097ce3b4d8f99f2a5396ec2a` fixes lowercase run identity and deterministic file-SD cleanup. Both pre-acceptance failures remain immutable with 0 acceptance requests (`b94ec797...f477b`, `b5edb5a1...31c10a`), and every baseline was restored. The complete matrix restarted; all AC remain pending/non-credit. |
