...
| `EVM-301` | X1 Heterogeneous-model Concurrency | Contract Frozen / Non-Credit / Jira `SCRUM-212` In Progress | EVM-300 verified | Six pre-Q0 suites remain immutable zero-credit. Numeric Triton protobuf version-policy semantics are remediated and refrozen at `3ca9ba5e...7c323` with string-substitution rejection and combined X1/S4/ledger `112/112`. A wholly fresh artifact/Q0/54-calibration suite remains required; 78-run credit remains not started. |
