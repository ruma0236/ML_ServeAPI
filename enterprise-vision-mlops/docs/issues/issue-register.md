...
| `EVM-301` | X1 Heterogeneous-model Concurrency | Contract Frozen / Non-Credit / Jira `SCRUM-212` In Progress | EVM-300 verified | Two pre-Q0 fresh suites remain immutable zero-credit. Import-order remediation and governed Criteo schema alignment `67c5b52...5359ca` passed actual-shard/alias tests, focused 21 and combined 76 with cleanup intact and no threshold/matrix changes. Fresh artifact/Q0/calibration is required; 78-run credit remains not started. |
