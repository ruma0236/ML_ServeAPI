...
| `EVM-267` | Scenario B invalid model canary and rollback | In Progress | Sprint 178 | B0 contract passed at `docs/status/2026-08-02-scenario-b-controlled-canary-contract.md`: real immutable B7 candidate `3058c67e...d6f4` fails F1 `0.6369 < 0.75`; B1-B7 implement non-disruptive shadow and <=10% isolated controlled replay with exact stable-route rollback. Production rollout remains fail-closed until Scenario D, dual-model GPU admission and separate maintenance approval pass; no business A/B claim. |
