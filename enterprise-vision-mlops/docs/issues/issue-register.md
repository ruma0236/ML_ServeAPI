...
| `S4` | `EVM-294` | HIGGS Tiny MLP GPU Batching | Implementing | Post-W8 | batch-one preparation passed; the first full attempt retained 15 repetitions and stopped fail closed on delayed OTLP flush, with cleanup intact; a bounded trace-flush RCA pilot, fresh 60+3+3 matrix and all ACs remain pending |
