...
| `EVM-301` | X1 Heterogeneous-model Concurrency | Remediation Required / Zero Credit / Jira `SCRUM-212` In Progress | EVM-300 verified | Twelve failed suites and all diagnostics remain immutable zero/non-credit. Follow-up `x1-diagnostic-20260829t234720z-1cdbbe78` exposed an unbounded host replay wrapper and was stopped with exact cleanup; bounded child-process remediation is `23379025e84b1144737a00d153c0fa1328029e0c`. Fresh refreeze/rerun is next; Q0/54 calibrations and 78-run credit remain not started. |
