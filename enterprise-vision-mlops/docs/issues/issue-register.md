...
| `EVM-228` | Compressed W6/W7 integration review | In Progress | 2026-07-W7 | real data/model, UI evidence, EVM-236 evaluator, EVM-233 policy, EVM-234 measured review-first drift, and the EVM-235 CI/deployment-intent implementation are complete; final closeout still requires EVM-226 GPU runtime proof and a live EVM-235 apply/rollback after readiness passes |
