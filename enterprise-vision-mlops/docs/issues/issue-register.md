...
| `S4` | `EVM-294` | HIGGS Tiny MLP GPU Batching | Implementing | Post-W8 | batch-one preparation and the corrected 64-concurrency trace pilot passed with 24/24 sampled chains and exact cleanup; the fresh 60+3+3 matrix and all ACs remain pending |
