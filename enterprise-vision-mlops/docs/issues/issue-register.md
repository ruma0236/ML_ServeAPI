...
| `EVM-237` | Torch EfficientNet-B0/B7 real model matrix | In Progress | 2026-07-W7 | W7 Torch/CUDA runtime preflight is complete in `docs/status/2026-07-10-w7-efficientnet-runtime-preflight.md`; `efficientnet-training` pipeline and Control Panel model-matrix evidence ingestion are implemented in `docs/status/2026-07-10-w7-efficientnet-training-pipeline.md`; actual EfficientNet-B0/B7 candidate training, MLflow runs, artifacts, metrics, and populated `CycleRun.model_matrix` evidence remain pending |
