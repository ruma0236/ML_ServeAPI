...
| `EVM-226` | Kubernetes local real execution proof | In Progress | 2026-07-W7 | proof runner added and kustomize render captured in `docs/status/2026-07-10-w7-kubernetes-real-execution-proof.md`; actual `kubectl apply`, pod/job logs, and Kubernetes-produced artifacts remain blocked because Docker Desktop Kubernetes is disabled/stopped |
| `EVM-227` | GPU/VLM serving deployment design | Done | 2026-07-W7 | Windows RTX, Mac mini evaluator, KServe/Triton/vLLM/Ray Serve options, and GPU scheduling constraints are compared with live resource evidence in `docs/status/2026-07-10-w7-gpu-vlm-serving-deployment-design.md`; K8s serving implementation remains blocked by EVM-226 and Torch CUDA setup remains a prerequisite for EVM-237 |
| `EVM-228` | Compressed W6/W7 integration review | In Progress | 2026-07-W7 | real VisA lifecycle replay, Compose API Control Panel route remediation, UI all-tab desktop/mobile verification, deployment/monitor checks, and remaining production gaps are captured in `docs/status/2026-07-09-w7-real-data-lifecycle-replay-review.md`; final closeout remains blocked by EVM-226, EVM-237, and EVM-238-B |
...
| `EVM-233` | Enterprise service tenancy and environment scope | Done | 2026-07-W7 | W7 API/UI exposes team, department, internal/external service scope, data/model/ops owners, environment tier, namespace/cluster, approval policy, and promotion state; verified by `docs/status/2026-07-09-w7-evm-233-236-enterprise-readiness.md` |
| `EVM-234` | Drift detection and retraining trigger surface | Done | 2026-07-W7 | data drift, prediction drift, reference/current dataset versions, drift report URI, label-review/retrain/block actions, and UI drilldown are represented in cycle detail; verified by `docs/status/2026-07-09-w7-evm-234-235-drift-cdct-gates.md` |
| `EVM-235` | CD/CT push verification and promotion gate | Done | 2026-07-W7 | push/PR checks, image build, kustomize render, data quality, model eval, drift review, CT trigger, and promotion blockers are represented as a pass/fail gate before deploy/promote; verified by `docs/status/2026-07-09-w7-evm-234-235-drift-cdct-gates.md` |
| `EVM-236` | Enterprise data/model pipeline readiness checklist | Done | 2026-07-W7 | data pipeline readiness covers source policy, schema, quality, lineage, replay/backfill; model pipeline readiness covers MLflow tracking, eval reports, registry, model card, rollback, and owner approval; verified by `docs/status/2026-07-09-w7-evm-233-236-enterprise-readiness.md` |
| `EVM-237` | Torch EfficientNet-B0/B7 real model matrix | In Progress | 2026-07-W7 | W7 Torch/CUDA runtime preflight is complete in `docs/status/2026-07-10-w7-efficientnet-runtime-preflight.md`; `efficientnet-training` pipeline and Control Panel model-matrix evidence ingestion are implemented in `docs/status/2026-07-10-w7-efficientnet-training-pipeline.md`; first real candidate `effnet-b0-img224-freeze-adamw` ran for 5 epochs with MLflow run `eeac494a65b447e4bb4a65ce7a101ca9` and partial matrix `warn` in `docs/status/2026-07-10-w7-efficientnet-b0-freeze-real-run.md`; remaining B0 fine-tune and B7 candidates, full metric matrix, and `EVM-238-B` validation remain pending |
