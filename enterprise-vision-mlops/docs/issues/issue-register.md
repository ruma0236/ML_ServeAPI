...
| `EVM-228` | Compressed W6/W7 integration review | In Progress | 2026-07-W7 | executable closeout matrix `evm.w7.closeout_matrix.v1` reads the live CycleRun/resource APIs and reports 7 passing claims plus 6 required blockers: Kubernetes GPU training, serving rollout, artifact readiness, environment policy, deployment apply, and rollback. Review checkpoint is in `docs/status/2026-07-10-w7-integration-review.md`; EVM-228 remains open until `closeout_allowed=true`. |
