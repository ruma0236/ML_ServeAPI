...
| `S8` | `EVM-298` | Dependency Soak & Resource-efficiency Closure | Implementing | Post-W8 | opt-in dependency circuit and frozen 35 RPS soak contract are implemented; isolated fault, 30-minute x3 soak, regression and hash closure remain pending |
