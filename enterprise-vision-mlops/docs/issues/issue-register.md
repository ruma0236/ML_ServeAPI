...
| `S4` | `EVM-294` | HIGGS Tiny MLP GPU Batching | Implementing | Post-W8 | 60 matrix + 3 instance repetitions completed 195,587 requests with zero errors/OOM/trace gaps, then stopped before open-loop on a saturation-vs-SLO analyzer defect; a fresh 60+3+3 rerun and all ACs remain pending |
