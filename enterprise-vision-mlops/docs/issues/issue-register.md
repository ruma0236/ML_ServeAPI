...
| `EVM-300` | S6B-M Triton Model Blue/Green | Planned / Not Run / Jira `SCRUM-211` To Do | EVM-299 verified | Dependency is now satisfied. One Triton GPU Pod; warmup, 10% canary, switch, drain, unload, exact rollback and wrong-digest fail-closed evidence remain pending. |
