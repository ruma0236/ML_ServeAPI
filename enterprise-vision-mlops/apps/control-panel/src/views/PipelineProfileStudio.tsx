          ...
          {activeStep === "release" ? (
            <div className="blueprint-step-content" data-step="release">
              ...
              <div className="profile-form-grid">
                ...
                <SelectField label="Approval" value={profile.gates.approval_policy} options={["manual", "two_person", "change_ticket", "automated_non_production"]} onChange={(value) => updateProfile({ ...profile, gates: { ...profile.gates, approval_policy: value as "manual" | "two_person" | "change_ticket" | "automated_non_production" } })} />
